# 📥 دانلود ویدیو از یوتیوب با ,itHub Actions
.1,,
این مخزن با استفاده از **GitHub Actions** .بهت ا..**ارسال لینک یوتیوب توی پیام کامیت**، ویدیو به‌صورت خودکار دانلود بشه و توی مخزن ذخیره بشه.
